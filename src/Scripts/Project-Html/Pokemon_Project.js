...
<div class="ProjectPopup">
	...
	<div class="description">
		...
		<div>
			...
			<br />
			<p class="Paragraph">
				We expanded upon this purpose by creating a "Pokedex" where data about which Pokemon the user has been quizzed on is stored. This data is stored inside of a browser cookie to prevent it from being lost when the user leaves the web page. For purposes of the "Pokedex", a pokemon is considered
				to be caught if it has been correctly identified in the quiz and seen if it was incorrectly identified.
			</p>
			<br />
